                    ...
                    <div className="w-48 mr-2">
                        <Listbox value={initialValue} onChange={onChange}>
                            <div className="relative mt-1">
                                <Listbox.Button className="relative w-full py-1.5 pl-3 pr-10 text-left bg-gray-50 dark:bg-black-700 border border-gray-300 dark:border-gray-700 rounded-sm cursor-pointer sm:text-sm hover:bg-gray-100 transition duration-75 dark:hover:bg-black-600">
                                ...
                                >
                                    <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm dark:bg-black-700">
                                        {PARAGRAPH_STYLES.map((style, i) => (
                                            <Listbox.Option
                                                key={i}
                                                className="relative py-2 pl-4 pr-4 text-gray-900 cursor-pointer group hover:bg-gray-100 dark:hover:bg-black-600"
                                                value={style}
                                            >
